/* ============================================================
   NEXUS — SVG Icon Library
   ============================================================
   Usage: Icons.get('home')  → SVG string
          Icons.el('home')   → SVGElement
   ============================================================ */
...
const Icons = (() => {
    const lib = {
        ...
        sparkle: `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3l1.5 4.5L18 9l-4.5 1.5L12 15l-1.5-4.5L6 9l4.5-1.5z"/><path d="M5 3l.5 1.5L7 5l-1.5.5L5 7l-.5-1.5L3 5l1.5-.5z"/><path d="M19 17l.5 1.5L21 19l-1.5.5L19 21l-.5-1.5L17 19l1.5-.5z"/></svg>`,
    ...
    function get(name) { return lib[name] || lib.sparkle; }

    function el(name, size = 20) {
